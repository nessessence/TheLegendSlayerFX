...
public class MonsterAI extends Sprite implements IRenderable {
	/* *****************************************
...
//	    private final int BOARD_HEIGHT = Map.BOARD_HEIGHT;
	    ...
	    public MonsterAI(int x, int y, String difficulty, String type, boolean powerUp) {
	        super(x, y);
...
//	            this.imageRight = "image/tank_basic_right.png";
	        if ("basic".equals(this.type)) {
	            loadImage("image/slime_right.gif");
	            getImageDimensions();
	            this.imageUp = "image/slime_right.gif";
	            this.imageDown = "image/slime_right.gif";
	            this.imageLeft = "image/slime_left.gif";
	            this.imageRight = "image/slime_right.gif";
//	        } else if ("armor".equals(this.type)) {
...
//	            this.imageRight = "image/tank_armor_right.png";
	...
	// unicorn dance
	            ...
	            loadImage("image/unicorn_dance.gif");
	            getImageDimensions();
	            this.imageUp = "image/unicorn_dance.gif";
	            this.imageDown = "image/unicorn_dance.gif";
	            this.imageLeft = "image/unicorn_dance.gif";
	            this.imageRight = "image/unicorn_dance.gif";
//	        } else if ("power".equals(this.type)) {
...
//	            this.imageRight = "image/tank_power_right.png";
	            ...
	            loadImage("image/zombie_dance.gif");
	            getImageDimensions();
	            this.imageUp = "image/zombie_dance.gif";
	            this.imageDown = "image/zombie_dance.gif";
	            this.imageLeft = "image/zombie_dance.gif";
	            this.imageRight = "image/zombie_dance.gif";
//	        } else if ("fast".equals(this.type)) {
...
//	        }
	            ...
	            loadImage("image/zombie_up.gif");
	            getImageDimensions();
	            this.imageUp = "image/zombie_up.gif";
	            this.imageDown = "image/zombie_down.gif";
	            this.imageLeft = "image/zombie_left.gif";
	            this.imageRight = "image/zombie_right.gif";
	        }
	    }
...
//	    }
	     ...
	     * @author Hung Giang
	     */
	    public void actionNormal(Player player) {
...
//	        }
	     ...
	     * @author Hung Giang
	     */
	    public void actionHard(Player player) {
	        Random randomDir = new Random();
	        if (this.dirTimer >= this.dirUpdateInterval) {
...
//	        if (CollisionUtility.checkCollisionTankBlocks(theTank) == false) {   // check collision
//	            x += dx;
//	            y += dy;
//	        }
//
...
//	        }
	    ...
	    public void fire() {
	        ...
	        ////
	            case 0:
	                aBullet = new Bullet(x + width / 3, y, 0);
	                break;
	            case 1:
	                aBullet = new Bullet(x + width, y + height / 3, 1);
	                break;
	            case 2:
	                aBullet = new Bullet(x + width / 3, y + height, 2);
	                break;
	            default:
	                aBullet = new Bullet(x, y + height / 3, 3);
	                break;
	        }
	        if (frozen) {
	        } else {
...
//	        SoundUtility.fireSound();
	     ...
	     * @author Hung Giang
	     */
	    public void toTankDir(Player player) {
	        int tankX = (int)player.x;
	        int tankY = (int)player.y;
	        Random randomDir = new Random();
	    ...
	    public void draw(GraphicsContext gc) {
	    	Image xxx = new Image(ClassLoader.getSystemResource("Bullet_top.png").toString()) ;
	        gc.drawImage(xxx , this.x, this.y);
	    }
	    public void update() {
	        if(this.direction == 0) {
	            this.y -= 10;
